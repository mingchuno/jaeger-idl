...
namespace Jaeger.ApiV2 {
  public static partial class CollectorService
  {
    ...
    static readonly grpc::Marshaller<global::Jaeger.ApiV2.PostSpansRequest> __Marshaller_jaeger_api_v2_PostSpansRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Jaeger.ApiV2.PostSpansRequest.Parser));
    static readonly grpc::Marshaller<global::Jaeger.ApiV2.PostSpansResponse> __Marshaller_jaeger_api_v2_PostSpansResponse = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::Jaeger.ApiV2.PostSpansResponse.Parser));
