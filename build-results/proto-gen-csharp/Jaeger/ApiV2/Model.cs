...
namespace Jaeger.ApiV2 {
    ...
    static ModelReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "TE9XU19GUk9NEAFCLAoXaW8uamFlZ2VydHJhY2luZy5hcGlfdjJaBW1vZGVs",
            "yOIeAdDiHgHg4h4BYgZwcm90bzM="));
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      processMap_.WriteTo(ref output, _repeated_processMap_codec);
      warnings_.WriteTo(ref output, _repeated_warnings_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(ref output);
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 18: {
            processMap_.AddEntriesFrom(ref input, _repeated_processMap_codec);
            break;
          }
          case 26: {
            warnings_.AddEntriesFrom(ref input, _repeated_warnings_codec);
