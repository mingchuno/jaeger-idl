...
public final class QueryServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.jaegertracing.api_v3.QueryServiceOuterClass.GetTraceRequest,
      io.jaegertracing.api_v3.QueryServiceOuterClass.SpansResponseChunk> getGetTraceMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      responseType = io.jaegertracing.api_v3.QueryServiceOuterClass.SpansResponseChunk.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<io.jaegertracing.api_v3.QueryServiceOuterClass.GetTraceRequest,
      io.jaegertracing.api_v3.QueryServiceOuterClass.SpansResponseChunk> getGetTraceMethod() {
    io.grpc.MethodDescriptor<io.jaegertracing.api_v3.QueryServiceOuterClass.GetTraceRequest, io.jaegertracing.api_v3.QueryServiceOuterClass.SpansResponseChunk> getGetTraceMethod;
    if ((getGetTraceMethod = QueryServiceGrpc.getGetTraceMethod) == null) {
      synchronized (QueryServiceGrpc.class) {
        if ((getGetTraceMethod = QueryServiceGrpc.getGetTraceMethod) == null) {
          QueryServiceGrpc.getGetTraceMethod = getGetTraceMethod =
              io.grpc.MethodDescriptor.<io.jaegertracing.api_v3.QueryServiceOuterClass.GetTraceRequest, io.jaegertracing.api_v3.QueryServiceOuterClass.SpansResponseChunk>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.jaegertracing.api_v3.QueryServiceOuterClass.SpansResponseChunk.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.jaegertracing.api_v3.QueryServiceOuterClass.FindTracesRequest,
      io.jaegertracing.api_v3.QueryServiceOuterClass.SpansResponseChunk> getFindTracesMethod;
  ...
  public static io.grpc.MethodDescriptor<io.jaegertracing.api_v3.QueryServiceOuterClass.FindTracesRequest,
      io.jaegertracing.api_v3.QueryServiceOuterClass.SpansResponseChunk> getFindTracesMethod() {
    io.grpc.MethodDescriptor<io.jaegertracing.api_v3.QueryServiceOuterClass.FindTracesRequest, io.jaegertracing.api_v3.QueryServiceOuterClass.SpansResponseChunk> getFindTracesMethod;
    if ((getFindTracesMethod = QueryServiceGrpc.getFindTracesMethod) == null) {
      synchronized (QueryServiceGrpc.class) {
        if ((getFindTracesMethod = QueryServiceGrpc.getFindTracesMethod) == null) {
          QueryServiceGrpc.getFindTracesMethod = getFindTracesMethod =
              io.grpc.MethodDescriptor.<io.jaegertracing.api_v3.QueryServiceOuterClass.FindTracesRequest, io.jaegertracing.api_v3.QueryServiceOuterClass.SpansResponseChunk>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  ...
  public static abstract class QueryServiceImplBase implements io.grpc.BindableService {
    ...
    public void getTrace(io.jaegertracing.api_v3.QueryServiceOuterClass.GetTraceRequest request,
        io.grpc.stub.StreamObserver<io.jaegertracing.api_v3.QueryServiceOuterClass.SpansResponseChunk> responseObserver) {
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                ...
                io.jaegertracing.api_v3.QueryServiceOuterClass.SpansResponseChunk>(
  ...
  public static final class QueryServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<QueryServiceBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<io.jaegertracing.api_v3.QueryServiceOuterClass.SpansResponseChunk> getTrace(
     ...
     * </pre>
     */
    public java.util.Iterator<io.jaegertracing.api_v3.QueryServiceOuterClass.SpansResponseChunk> findTraces(
